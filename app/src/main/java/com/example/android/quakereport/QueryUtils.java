...
public final class QueryUtils {
     ...
     */
    private static ArrayList<EarthquakeEntry> extractEarthquakes(String JSONResponse) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                earthquakes.add(new EarthquakeEntry(newCity, newMag, newTime, newURL));
            }
     ...
     */
    public static List<EarthquakeEntry> fetchEarthquakeData(String requestUrl) {
        ...
        List<EarthquakeEntry> earthquakes = extractEarthquakes(jsonResponse);
